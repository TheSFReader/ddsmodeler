...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Subscriber Status</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see ddsMetamodel.DdsMetamodelPackage#getSubscriberStatus()
 * @model
 * @generated
 */
public enum SubscriberStatus implements Enumerator {
	/**
	 ...
	 * @ordered
	 */
	DATA_ON_READERS_STATUS(0, "DATA_ON_READERS_STATUS", "DATA_ON_READERS_STATUS"), /**
	 ...
	 * @ordered
	 */
	DATA_AVAILABLE_STATUS(1, "DATA_AVAILABLE_STATUS", "DATA_AVAILABLE_STATUS"), /**
	 ...
	 * @ordered
	 */
	LIVELINESS_CHANGED_STATUS(2, "LIVELINESS_CHANGED_STATUS", "LIVELINESS_CHANGED_STATUS"), /**
	 ...
	 * @ordered
	 */
	SAMPLE_REJECTED_STATUS(6, "SAMPLE_REJECTED_STATUS", "SAMPLE_REJECTED_STATUS"), /**
	 ...
	 * @ordered
	 */
	SUBSCRIPTION_MATCHED_STATUS(7, "SUBSCRIPTION_MATCHED_STATUS", "SUBSCRIPTION_MATCHED_STATUS");
	 ...
	 * @ordered
	 */
	public static final int DATA_ON_READERS_STATUS_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int DATA_AVAILABLE_STATUS_VALUE = 1;
	 ...
	 * @ordered
	 */
	public static final int LIVELINESS_CHANGED_STATUS_VALUE = 2;
	 ...
	 * @ordered
	 */
	public static final int SAMPLE_REJECTED_STATUS_VALUE = 6;
	 ...
	 * @ordered
	 */
	public static final int SUBSCRIPTION_MATCHED_STATUS_VALUE = 7;

	/**
	 * An array of all the '<em><b>Subscriber Status</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final SubscriberStatus[] VALUES_ARRAY =
	...
	/**
	 * A public read-only list of all the '<em><b>Subscriber Status</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<SubscriberStatus> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Subscriber Status</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static SubscriberStatus get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			SubscriberStatus result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Subscriber Status</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static SubscriberStatus getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			SubscriberStatus result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Subscriber Status</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static SubscriberStatus get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private SubscriberStatus(int value, String name, String literal) {
		this.value = value;
		this.name = name;
