...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Data Writer Status</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see ddsMetamodel.DdsMetamodelPackage#getDataWriterStatus()
 * @model
 * @generated
 */
public enum DataWriterStatus implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Data Writer Status</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final DataWriterStatus[] VALUES_ARRAY =
		new DataWriterStatus[] {
	...
	/**
	 * A public read-only list of all the '<em><b>Data Writer Status</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<DataWriterStatus> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Data Writer Status</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static DataWriterStatus get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			DataWriterStatus result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Data Writer Status</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static DataWriterStatus getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			DataWriterStatus result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Data Writer Status</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static DataWriterStatus get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private DataWriterStatus(int value, String name, String literal) {
		this.value = value;
		this.name = name;
