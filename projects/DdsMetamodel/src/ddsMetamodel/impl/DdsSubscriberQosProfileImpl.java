...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Dds Subscriber Qos Profile</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ddsMetamodel.impl.DdsSubscriberQosProfileImpl#getGroupDataQos <em>Group Data Qos</em>}</li>
 *   <li>{@link ddsMetamodel.impl.DdsSubscriberQosProfileImpl#getEntityFactoryQos <em>Entity Factory Qos</em>}</li>
 *   <li>{@link ddsMetamodel.impl.DdsSubscriberQosProfileImpl#getPresentationQos <em>Presentation Qos</em>}</li>
 *   <li>{@link ddsMetamodel.impl.DdsSubscriberQosProfileImpl#getPartitionQos <em>Partition Qos</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DdsSubscriberQosProfileImpl extends DdsQosProfileImpl implements DdsSubscriberQosProfile {
	/**
	 ...
	 * @generated
	 */
	protected DdsSubscriberQosProfileImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return DdsMetamodelPackage.Literals.DDS_SUBSCRIBER_QOS_PROFILE;
	}
	...
	public NotificationChain basicSetGroupDataQos(DdsGroupDataQos newGroupDataQos, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DdsMetamodelPackage.DDS_SUBSCRIBER_QOS_PROFILE__GROUP_DATA_QOS, oldGroupDataQos, newGroupDataQos);
	...
	public void setGroupDataQos(DdsGroupDataQos newGroupDataQos) {
		if (newGroupDataQos != groupDataQos) {
			...
			if (groupDataQos != null)
				msgs = ((InternalEObject)groupDataQos).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DdsMetamodelPackage.DDS_SUBSCRIBER_QOS_PROFILE__GROUP_DATA_QOS, null, msgs);
			if (newGroupDataQos != null)
				msgs = ((InternalEObject)newGroupDataQos).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DdsMetamodelPackage.DDS_SUBSCRIBER_QOS_PROFILE__GROUP_DATA_QOS, null, msgs);
			msgs = basicSetGroupDataQos(newGroupDataQos, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DdsMetamodelPackage.DDS_SUBSCRIBER_QOS_PROFILE__GROUP_DATA_QOS, newGroupDataQos, newGroupDataQos));
	}
	...
	public NotificationChain basicSetEntityFactoryQos(DdsEntityFactoryQos newEntityFactoryQos, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DdsMetamodelPackage.DDS_SUBSCRIBER_QOS_PROFILE__ENTITY_FACTORY_QOS, oldEntityFactoryQos, newEntityFactoryQos);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setEntityFactoryQos(DdsEntityFactoryQos newEntityFactoryQos) {
		if (newEntityFactoryQos != entityFactoryQos) {
			...
			if (entityFactoryQos != null)
				msgs = ((InternalEObject)entityFactoryQos).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DdsMetamodelPackage.DDS_SUBSCRIBER_QOS_PROFILE__ENTITY_FACTORY_QOS, null, msgs);
			if (newEntityFactoryQos != null)
				msgs = ((InternalEObject)newEntityFactoryQos).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DdsMetamodelPackage.DDS_SUBSCRIBER_QOS_PROFILE__ENTITY_FACTORY_QOS, null, msgs);
			msgs = basicSetEntityFactoryQos(newEntityFactoryQos, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DdsMetamodelPackage.DDS_SUBSCRIBER_QOS_PROFILE__ENTITY_FACTORY_QOS, newEntityFactoryQos, newEntityFactoryQos));
	}
	...
	public NotificationChain basicSetPresentationQos(DdsPresentationQos newPresentationQos, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DdsMetamodelPackage.DDS_SUBSCRIBER_QOS_PROFILE__PRESENTATION_QOS, oldPresentationQos, newPresentationQos);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPresentationQos(DdsPresentationQos newPresentationQos) {
		if (newPresentationQos != presentationQos) {
			...
			if (presentationQos != null)
				msgs = ((InternalEObject)presentationQos).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DdsMetamodelPackage.DDS_SUBSCRIBER_QOS_PROFILE__PRESENTATION_QOS, null, msgs);
			if (newPresentationQos != null)
				msgs = ((InternalEObject)newPresentationQos).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DdsMetamodelPackage.DDS_SUBSCRIBER_QOS_PROFILE__PRESENTATION_QOS, null, msgs);
			msgs = basicSetPresentationQos(newPresentationQos, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DdsMetamodelPackage.DDS_SUBSCRIBER_QOS_PROFILE__PRESENTATION_QOS, newPresentationQos, newPresentationQos));
	}
	...
	public NotificationChain basicSetPartitionQos(DdsPartitionQos newPartitionQos, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DdsMetamodelPackage.DDS_SUBSCRIBER_QOS_PROFILE__PARTITION_QOS, oldPartitionQos, newPartitionQos);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPartitionQos(DdsPartitionQos newPartitionQos) {
		if (newPartitionQos != partitionQos) {
			...
			if (partitionQos != null)
				msgs = ((InternalEObject)partitionQos).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DdsMetamodelPackage.DDS_SUBSCRIBER_QOS_PROFILE__PARTITION_QOS, null, msgs);
			if (newPartitionQos != null)
				msgs = ((InternalEObject)newPartitionQos).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DdsMetamodelPackage.DDS_SUBSCRIBER_QOS_PROFILE__PARTITION_QOS, null, msgs);
			msgs = basicSetPartitionQos(newPartitionQos, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DdsMetamodelPackage.DDS_SUBSCRIBER_QOS_PROFILE__PARTITION_QOS, newPartitionQos, newPartitionQos));
	}
