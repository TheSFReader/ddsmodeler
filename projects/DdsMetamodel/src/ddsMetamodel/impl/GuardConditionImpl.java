 ...
 * </p>
 * <ul>
 *   <li>{@link ddsMetamodel.impl.GuardConditionImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GuardConditionImpl extends MinimalEObjectImpl.Container implements GuardCondition {
	...
	protected EClass eStaticClass() {
		return DdsMetamodelPackage.Literals.GUARD_CONDITION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DdsMetamodelPackage.GUARD_CONDITION__NAME, oldName, name));
	}
