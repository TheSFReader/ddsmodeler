...
public class ChatMessageDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements ChatMessageDataReader
{
    private long copyCache;
    private ChatMessageTypeSupport typeSupport;

    public ChatMessageDataReaderImpl(ChatModule.ChatMessageTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            ChatModule.ChatMessageSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            ChatModule.ChatMessageHolder received_data,
    ...
    */
    ...
    synchronized public long lookup_instance(
        ChatModule.ChatMessage instance)
    {
        long uReader = 0;
    ...
    {
        return new ChatMessageDataReaderViewImpl(typeSupport);
    }
}
