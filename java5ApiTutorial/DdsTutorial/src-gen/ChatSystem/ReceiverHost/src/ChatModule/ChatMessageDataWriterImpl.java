...
public class ChatMessageDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements ChatMessageDataWriter
{
    private long copyCache;
    private ChatMessageTypeSupport typeSupport;

    public ChatMessageDataWriterImpl(ChatModule.ChatMessageTypeSupport ts)
    {
        typeSupport = ts;
