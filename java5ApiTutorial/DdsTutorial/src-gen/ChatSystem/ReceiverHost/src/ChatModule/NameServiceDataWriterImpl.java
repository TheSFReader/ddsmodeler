...
public class NameServiceDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements NameServiceDataWriter
{
    private long copyCache;
    private NameServiceTypeSupport typeSupport;

    public NameServiceDataWriterImpl(ChatModule.NameServiceTypeSupport ts)
    {
        typeSupport = ts;
