...
public class ChatMessageDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements ChatMessageDataReaderView
{
    private long copyCache;
    private ChatMessageTypeSupport typeSupport;

    public ChatMessageDataReaderViewImpl(ChatModule.ChatMessageTypeSupport ts)
    {
        typeSupport = ts;
