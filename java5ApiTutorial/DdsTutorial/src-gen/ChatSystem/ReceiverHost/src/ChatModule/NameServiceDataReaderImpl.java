...
public class NameServiceDataReaderImpl extends org.opensplice.dds.dcps.FooDataReaderImpl implements NameServiceDataReader
{
    private long copyCache;
    private NameServiceTypeSupport typeSupport;

    public NameServiceDataReaderImpl(ChatModule.NameServiceTypeSupport ts)
    {
        typeSupport = ts;
    ...
    synchronized public int read(
            ChatModule.NameServiceSeqHolder received_data,
    ...
    synchronized public int read_next_sample(
            ChatModule.NameServiceHolder received_data,
    ...
    */
    ...
    synchronized public long lookup_instance(
        ChatModule.NameService instance)
    {
        long uReader = 0;
    ...
    {
        return new NameServiceDataReaderViewImpl(typeSupport);
    }
}
