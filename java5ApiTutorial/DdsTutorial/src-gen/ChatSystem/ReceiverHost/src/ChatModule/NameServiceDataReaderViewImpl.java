...
public class NameServiceDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements NameServiceDataReaderView
{
    private long copyCache;
    private NameServiceTypeSupport typeSupport;

    public NameServiceDataReaderViewImpl(ChatModule.NameServiceTypeSupport ts)
    {
        typeSupport = ts;
